...
<b>I'm {bot} a smart autofilter bot !
you just add me to your group & see the magic! 😇

Support Me Forever Thank You ☺️ 

நன்றி  {} மீண்டும் வாருக !!!</b></b> <b><a href=https://t.me/TamilRockerz_TR>🦋 𝐓𝐚𝐦𝐢𝐥𝐑𝐨𝐜𝐤𝐞𝐫𝐳 𝐓𝐑 🦋</a></b>,

<b> GROUP OR BOT BUGE OR திரைப்பட இணைப்பு கிடைக்கவில்லை ANY PROMBLEM CONTACT #ADMIN @Kalitgadmin_Bot!!!</b>"""
    OWNER_TXT = """<b>⍟───[ ᴏᴡɴᴇʀ ᴅᴇᴛᴀɪʟꜱ ]───⍟</b>
    
<b>• ꜰᴜʟʟ ɴᴀᴍᴇ : 𝐊𝐚𝐥𝐢🕊️ ⃟⃟⃝⃪⃟⃝🦋─⃛͢</b>
<b>• Uꜱᴇʀ ɴᴀᴍᴇ : @Kalitgadmin_Bot
• Usᴇʀ ɪᴅ :</b> <code>6194062192</code>
...
<b>• ηαмє : 𝐊𝐚𝐥𝐢🕊️ ⃟⃟⃝⃪⃟⃝🦋─⃛͢
• υѕєя ηαмє : @Kalitgadmin_Bot
• υѕєя ι∂ :</b> <code>6194062192</code>
</b>
...
<b>DEVS:</b>
- <a href=https://t.me/Kalitgadmin_Bot>𝐊𝐚𝐥𝐢🕊️ ⃟⃟⃝⃪⃟⃝🦋─⃛͢</a>"""
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @Kalitgadmin_Bot"""
    JSON_TXT = """<b>JSON:</b>
...
<b>╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
♻️ 𝙅𝙊𝙄𝙉 :- <a href="https://t.me/+6L7dnBl8-N4zYzZl">OTT UPDATES</a>
♻️ 𝙅𝙊𝙄𝙉 :- <a href="t.me/TamilRockerz_TR">CHANNEL</a>
♻️ 𝙅𝙊𝙄𝙉 :- <a href="https://t.me/Movies_Request_TR">GROUP</a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>
"""
    SUR_TXT = """
<b>
...
<b>Exᴄʟᴜꜱɪᴠᴇʟʏ Mᴀᴅᴇ Tʜɪꜱ Bᴏᴛ Fᴏʀ @TamilRockerz_TR..!! 💫</b>

<b>📌 Sᴜᴘᴘᴏʀᴛ : @TamilRockerz_TR</b>

<b>🍂 Oᴡɴᴇʀ : @Kalitgadmin_Bot</b>"""
...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
▫️<a href=https://t.me/TamilRockerz_TR> ᴄʜᴀɴɴᴇʟ </a>

▫️<a href=https://t.me/Movies_Request_TR> ɢʀᴏᴜᴘ </a>
╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>"""
...
1️⃣ கூகுளில் ஸ்பெல்லிங் செய்யப்பட்டுள்ளபடி படத்தை டைப் செய்திருப்பதை உறுதி செய்து கொள்ளுங்கள்..!!

2️⃣ @TamilRockerz_TR நீங்கள் கேட்ட படம் OTT ரிலீஸானதா என்று பார்க்கவும்..!!

3️⃣ ஒரு திரைப்படத்திற்கு செய்தி அனுப்பும் போது, ​​படம் வெளியான ஆண்டை மட்டும் அனுப்பவும்..!!

4⃣ ‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @Kalitgadmin_Bot</b> """
...
4⃣ ‼ 𝖱𝖾𝗉𝗈𝗋𝗍 𝗍𝗈 𝖺𝖽𝗆𝗂𝗇 ▶ @Kalitgadmin_Bot</b> """
    ...
    CUDNT_FND = """<b>ʜᴇʟʟᴏ {} BRO எழுத்துப்பிழையைப் பார்த்து, பின்வரும் திரைப்படங்களில் எது உங்களுக்குத் தேவை என்பதை அறிய CURRET ஐக் கிளிக் செய்யவும்...</b>👇🏻"""
